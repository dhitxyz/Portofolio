          ...
          <div className="block">
            ...
            <div style={{ display: activeTab === 1 ? "block" : "none" }}>
              <div className="grid gap-4 grid-cols-6 grid-rows-3">
                ...
                <div className="group/item h-12 w-12 text-bottom flex items-center">
                  <span className="absolute group-hover/item:visible z-10 -mt-16 invisible w-auto px-2 -ml-1 text-center bg-slate-400/80 rounded-md">
                    SASS
                  </span>
                ...
                <div className="group/item h-12 w-12 text-bottom flex items-center">
                  <span className="absolute group-hover/item:visible z-10 -mb-20 invisible w-auto px-2 -ml-3 text-center bg-slate-400/80 rounded-md">
                    Laravel
                  </span>
                ...
                <div className="group/item h-12 w-12 text-bottom flex items-center dark:fill-white">
            ...
            <div style={{ display: activeTab === 2 ? "block" : "none" }}>
              <div className="grid gap-4 grid-cols-6 grid-rows-3">
                <div className="group/item h-12 w-12 text-bottom flex items-center">
                  <span className="absolute group-hover/item:visible z-10 -mb-20 invisible w-auto px-2 -ml-8 text-center bg-slate-400/80 rounded-md">
                    Visual Studio Code
                  </span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
